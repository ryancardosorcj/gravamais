    ...
    <AnimatePresence>
      {visivel && (
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-32 right-5 z-overlay flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg hover:bg-green-600 transition-colors"
        >
